...
%
% Plik jest przykładem wykorzystania klasy wimgr do formatowania 
% pracy magisterskiej przygotowanej na Wydziale Zarządzania 
% Uniwersytetu Gdańskiego.  
%
% Szkielet struktury tego dokumentu można wykorzystywać formatując 
...
%
% (c) T. Przechlewski (tomasz@gnu.univ.gda.pl) 2002--2005.
%
% Rozpowszechnianie tego pliku jest dozwolone na zasadach 
% licencji GNU (http://www.gnu.org).
%
% $Id: wimgr.tex,v 1.2 2005/06/18 21:25:27 tomek Exp $
%
...
%  * palatino    -- skład krojem Palatino (domyślnie Computer Modern)
%  * xodstep     -- podwójny odstęp między wierszami
%  * brudnopis   -- zalecany na etapie  tworzenia pracy
%
\documentclass[skorowidz,palatino,brudnopis,xodstep]{wimgr}
%\documentclass[skorowidz,brudnopis,xodstep]{wimgr}

% Opcjonalnie identyfikator dokumentu (drukowany tylko 
% z włączoną opcją `brudnopis'):
\nrwersji {0.1}

% Jeżeli Twój TeX psuje polskie znaki, uaktywnij poniższą deklarację:
...
%%\UniversityName{Wyższa Szkoła Zarządzania w Kwidzynie}
